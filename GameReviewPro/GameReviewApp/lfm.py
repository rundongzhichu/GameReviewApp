...
class Corpus:
    ...
    file_path1 =os.path.join(_change_status_root,'lfm.model')
    file_path2 =  os.path.join(_change_status_root,'ratings.csv')
    items_dict_path = os.path.join(_change_status_root, 'lfm_items.dict')

    @classmethod
    def pre_process(cls):
        cls.frame = pd.read_csv(cls.items_dict_path)
...
class LFM:
    ...
    def _init_model(self):
        ...
        self.frame = pd.read_csv(self.file_path2)
